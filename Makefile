...
FILES = main.c commands/commands.c env/env.c env/env_utils1.c utils/shell_init.c \
		...
		pipes/pipes.c pipes/pipes_aux1.c pipes/pipes_aux2.c utils/utils.c commands/signals.c pipes/redirections.c commands/commands2.c commands/commands3.c commands/commands4.c\
