...
FILES = main.c main_loop.c commands/commands.c env/env.c env/env_utils1.c utils/shell_init.c \
		...
		pipes/pipes.c pipes/args_pipe.c pipes/pipes_aux1.c pipes/pipes_aux2.c utils/utils.c commands/signals.c pipes/redirections.c \
